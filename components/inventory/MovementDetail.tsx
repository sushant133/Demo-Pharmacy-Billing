...
<<<<<<< HEAD
              <div className="relative max-h-[85dvh] w-full max-w-lg overflow-y-auto rounded-t-2xl bg-white pb-[var(--safe-bottom)] shadow-2xl sm:rounded-2xl sm:pb-0">
=======
              <div className="relative max-h-[calc(85dvh-var(--safe-top))] w-full max-w-lg overflow-y-auto rounded-t-2xl bg-white pb-[var(--safe-bottom)] shadow-2xl sm:rounded-2xl sm:pb-0">
